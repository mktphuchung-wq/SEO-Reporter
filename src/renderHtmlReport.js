...
export function renderHtmlReport({ insights, sourceInfo, keywordInsights = {}, keywordCsvDownloadUrl = "", reportDownloadUrl = "", saveReportPayload = "" }) {
  ...
  const reportTypeLabel = sourceInfo.reportType === "monthly" || filters.reportType === "monthly" ? "Monthly SEO Report" : sourceInfo.reportType === "quarterly" || filters.reportType === "quarterly" ? "Quarterly SEO Report" : "Custom Report";
